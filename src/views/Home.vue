  ...
  <div>
   ...
   <b-card-group class="col-md-3" v-for="n in events" v-bind:key="n.id">
        ...
        >
          ...
          <b-button class="bt" href="#" variant="primary">Check event</b-button>
        </b-card>
   </b-card-group>
  ...
  data(){
      return{
        ...
        },
        {
          ...
          eventDescription: "description of this event event event  eventevent event event event bla bla ",
        },
            {
          eventId: 2,
          imageURL: "https://picsum.photos/1024/400/?image=41",
